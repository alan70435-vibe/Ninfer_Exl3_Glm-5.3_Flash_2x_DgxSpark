...
// Normalized Walsh-Hadamard blocks of 128. Applying the transform twice returns the input.
...
// Greedy text tokens from the EXL3 checkpoint. world_size 2 forks a second process and exchanges GEMV
// row shards over a socket. Sequences longer than the indexer top-k are refused.
